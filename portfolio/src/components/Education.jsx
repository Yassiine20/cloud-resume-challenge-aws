  ...
  return (
    ...
    >
      <div className="glass-card gradient-border p-6 md:p-8">
        <div className="flex items-center gap-2 text-[#34d399] font-mono text-sm mb-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex items-start gap-4">
            {/* Icon */}
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#34d399]/20 to-[#22d3ee]/20 flex items-center justify-center text-[#22d3ee] flex-shrink-0">
